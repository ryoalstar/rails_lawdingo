module SearchHelper
  ...
  def get_homepage_images_hash images
    ...
    images.each do |image|
      ...
      images_hash["small"]="then #{number_to_currency (lawyer.rate_for_minutes(6) + AppParameter.service_charge_value)} per 6 mins"
      ...
      images_hash["ask_question_button_text"]  = start_or_schedule_button_text(lawyer)
      images_hash["ask_question_button"]  = start_or_schedule_button_text_profile(lawyer) 
